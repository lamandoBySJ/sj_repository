...
public:
    ...
    Event<void(ArgTs...)> event(R(*func)(B_0, ArgTs...), C0 c0);

    /** Creates an event bound to the event queue
     *  @see EventQueue::event
     */
    template <typename T, typename R, typename B_0, typename C0, typename... ArgTs>
    Event<void(ArgTs...)> event(T *obj, R(T::*method)(B_0, ArgTs...), C0 c0);

    /** Creates an event bound to the event queue
     *  @see EventQueue::event
     */
    template <typename T, typename R, typename B_0, typename C0, typename... ArgTs>
    Event<void(ArgTs...)> event(const T *obj, R(T::*method)(B_0, ArgTs...) const, C0 c0);

    /** Creates an event bound to the event queue
     *  @see EventQueue::event
     */
    template <typename T, typename R, typename B_0, typename C0, typename... ArgTs>
    Event<void(ArgTs...)> event(volatile T *obj, R(T::*method)(B_0, ArgTs...) volatile, C0 c0);

    /** Creates an event bound to the event queue
     *  @see EventQueue::event
     */
    template <typename T, typename R, typename B_0, typename C0, typename... ArgTs>
    Event<void(ArgTs...)> event(const volatile T *obj, R(T::*method)(B_0, ArgTs...) const volatile, C0 c0);

    /** Creates an event bound to the event queue
     *  @see EventQueue::event
     */
    template <typename R, typename B_0, typename C0, typename... ArgTs>
    Event<void(ArgTs...)> event(mbed::Callback<R(B_0, ArgTs...)> cb, C0 c0);

    /** Creates an event bound to the event queue
     *  @see EventQueue::event
     */
    template <typename R, typename B_0, typename B_1, typename C0, typename C1, typename... ArgTs>
    Event<void(ArgTs...)> event(R(*func)(B_0, B_1, ArgTs...), C0 c0, C1 c1);

    /** Creates an event bound to the event queue
     *  @see EventQueue::event
     */
    template <typename T, typename R, typename B_0, typename B_1, typename C0, typename C1, typename... ArgTs>
    Event<void(ArgTs...)> event(T *obj, R(T::*method)(B_0, B_1, ArgTs...), C0 c0, C1 c1);

    /** Creates an event bound to the event queue
     *  @see EventQueue::event
     */
    template <typename T, typename R, typename B_0, typename B_1, typename C0, typename C1, typename... ArgTs>
    Event<void(ArgTs...)> event(const T *obj, R(T::*method)(B_0, B_1, ArgTs...) const, C0 c0, C1 c1);

    /** Creates an event bound to the event queue
     *  @see EventQueue::event
     */
    template <typename T, typename R, typename B_0, typename B_1, typename C0, typename C1, typename... ArgTs>
    Event<void(ArgTs...)> event(volatile T *obj, R(T::*method)(B_0, B_1, ArgTs...) volatile, C0 c0, C1 c1);

    /** Creates an event bound to the event queue
     *  @see EventQueue::event
     */
    template <typename T, typename R, typename B_0, typename B_1, typename C0, typename C1, typename... ArgTs>
    Event<void(ArgTs...)> event(const volatile T *obj, R(T::*method)(B_0, B_1, ArgTs...) const volatile, C0 c0, C1 c1);

    /** Creates an event bound to the event queue
     *  @see EventQueue::event
     */
    template <typename R, typename B_0, typename B_1, typename C0, typename C1, typename... ArgTs>
    Event<void(ArgTs...)> event(mbed::Callback<R(B_0, B_1, ArgTs...)> cb, C0 c0, C1 c1);

    /** Creates an event bound to the event queue
     *  @see EventQueue::event
     */
    template <typename R, typename B_0, typename B_1, typename B_2, typename C0, typename C1, typename C2, typename... ArgTs>
    Event<void(ArgTs...)> event(R(*func)(B_0, B_1, B_2, ArgTs...), C0 c0, C1 c1, C2 c2);

    /** Creates an event bound to the event queue
     *  @see EventQueue::event
     */
    template <typename T, typename R, typename B_0, typename B_1, typename B_2, typename C0, typename C1, typename C2, typename... ArgTs>
    Event<void(ArgTs...)> event(T *obj, R(T::*method)(B_0, B_1, B_2, ArgTs...), C0 c0, C1 c1, C2 c2);

    /** Creates an event bound to the event queue
     *  @see EventQueue::event
     */
    template <typename T, typename R, typename B_0, typename B_1, typename B_2, typename C0, typename C1, typename C2, typename... ArgTs>
    Event<void(ArgTs...)> event(const T *obj, R(T::*method)(B_0, B_1, B_2, ArgTs...) const, C0 c0, C1 c1, C2 c2);

    /** Creates an event bound to the event queue
     *  @see EventQueue::event
     */
    template <typename T, typename R, typename B_0, typename B_1, typename B_2, typename C0, typename C1, typename C2, typename... ArgTs>
    Event<void(ArgTs...)> event(volatile T *obj, R(T::*method)(B_0, B_1, B_2, ArgTs...) volatile, C0 c0, C1 c1, C2 c2);

    /** Creates an event bound to the event queue
     *  @see EventQueue::event
     */
    template <typename T, typename R, typename B_0, typename B_1, typename B_2, typename C0, typename C1, typename C2, typename... ArgTs>
    Event<void(ArgTs...)> event(const volatile T *obj, R(T::*method)(B_0, B_1, B_2, ArgTs...) const volatile, C0 c0, C1 c1, C2 c2);

    /** Creates an event bound to the event queue
     *  @see EventQueue::event
     */
    template <typename R, typename B_0, typename B_1, typename B_2, typename C0, typename C1, typename C2, typename... ArgTs>
    Event<void(ArgTs...)> event(mbed::Callback<R(B_0, B_1, B_2, ArgTs...)> cb, C0 c0, C1 c1, C2 c2);

    /** Creates an event bound to the event queue
     *  @see EventQueue::event
     */
    template <typename R, typename B_0, typename B_1, typename B_2, typename B3, typename C0, typename C1, typename C2, typename C3, typename... ArgTs>
    Event<void(ArgTs...)> event(R(*func)(B_0, B_1, B_2, B3, ArgTs...), C0 c0, C1 c1, C2 c2, C3 c3);

    /** Creates an event bound to the event queue
     *  @see EventQueue::event
     */
    template <typename T, typename R, typename B_0, typename B_1, typename B_2, typename B3, typename C0, typename C1, typename C2, typename C3, typename... ArgTs>
    Event<void(ArgTs...)> event(T *obj, R(T::*method)(B_0, B_1, B_2, B3, ArgTs...), C0 c0, C1 c1, C2 c2, C3 c3);

    /** Creates an event bound to the event queue
     *  @see EventQueue::event
     */
    template <typename T, typename R, typename B_0, typename B_1, typename B_2, typename B3, typename C0, typename C1, typename C2, typename C3, typename... ArgTs>
    Event<void(ArgTs...)> event(const T *obj, R(T::*method)(B_0, B_1, B_2, B3, ArgTs...) const, C0 c0, C1 c1, C2 c2, C3 c3);

    /** Creates an event bound to the event queue
     *  @see EventQueue::event
     */
    template <typename T, typename R, typename B_0, typename B_1, typename B_2, typename B3, typename C0, typename C1, typename C2, typename C3, typename... ArgTs>
    Event<void(ArgTs...)> event(volatile T *obj, R(T::*method)(B_0, B_1, B_2, B3, ArgTs...) volatile, C0 c0, C1 c1, C2 c2, C3 c3);

    /** Creates an event bound to the event queue
     *  @see EventQueue::event
     */
    template <typename T, typename R, typename B_0, typename B_1, typename B_2, typename B3, typename C0, typename C1, typename C2, typename C3, typename... ArgTs>
    Event<void(ArgTs...)> event(const volatile T *obj, R(T::*method)(B_0, B_1, B_2, B3, ArgTs...) const volatile, C0 c0, C1 c1, C2 c2, C3 c3);

    /** Creates an event bound to the event queue
     *  @see EventQueue::event
     */
    template <typename R, typename B_0, typename B_1, typename B_2, typename B3, typename C0, typename C1, typename C2, typename C3, typename... ArgTs>
    Event<void(ArgTs...)> event(mbed::Callback<R(B_0, B_1, B_2, B3, ArgTs...)> cb, C0 c0, C1 c1, C2 c2, C3 c3);

    /** Creates an event bound to the event queue
     *  @see EventQueue::event
     */
    template <typename R, typename B_0, typename B_1, typename B_2, typename B3, typename B4, typename C0, typename C1, typename C2, typename C3, typename C4, typename... ArgTs>
    Event<void(ArgTs...)> event(R(*func)(B_0, B_1, B_2, B3, B4, ArgTs...), C0 c0, C1 c1, C2 c2, C3 c3, C4 c4);

    /** Creates an event bound to the event queue
     *  @see EventQueue::event
     */
    template <typename T, typename R, typename B_0, typename B_1, typename B_2, typename B3, typename B4, typename C0, typename C1, typename C2, typename C3, typename C4, typename... ArgTs>
    Event<void(ArgTs...)> event(T *obj, R(T::*method)(B_0, B_1, B_2, B3, B4, ArgTs...), C0 c0, C1 c1, C2 c2, C3 c3, C4 c4);

    /** Creates an event bound to the event queue
     *  @see EventQueue::event
     */
    template <typename T, typename R, typename B_0, typename B_1, typename B_2, typename B3, typename B4, typename C0, typename C1, typename C2, typename C3, typename C4, typename... ArgTs>
    Event<void(ArgTs...)> event(const T *obj, R(T::*method)(B_0, B_1, B_2, B3, B4, ArgTs...) const, C0 c0, C1 c1, C2 c2, C3 c3, C4 c4);

    /** Creates an event bound to the event queue
     *  @see EventQueue::event
     */
    template <typename T, typename R, typename B_0, typename B_1, typename B_2, typename B3, typename B4, typename C0, typename C1, typename C2, typename C3, typename C4, typename... ArgTs>
    Event<void(ArgTs...)> event(volatile T *obj, R(T::*method)(B_0, B_1, B_2, B3, B4, ArgTs...) volatile, C0 c0, C1 c1, C2 c2, C3 c3, C4 c4);

    /** Creates an event bound to the event queue
     *  @see EventQueue::event
     */
    template <typename T, typename R, typename B_0, typename B_1, typename B_2, typename B3, typename B4, typename C0, typename C1, typename C2, typename C3, typename C4, typename... ArgTs>
    Event<void(ArgTs...)> event(const volatile T *obj, R(T::*method)(B_0, B_1, B_2, B3, B4, ArgTs...) const volatile, C0 c0, C1 c1, C2 c2, C3 c3, C4 c4);

    /** Creates an event bound to the event queue
     *  @see EventQueue::event
     */
    template <typename R, typename B_0, typename B_1, typename B_2, typename B3, typename B4, typename C0, typename C1, typename C2, typename C3, typename C4, typename... ArgTs>
    Event<void(ArgTs...)> event(mbed::Callback<R(B_0, B_1, B_2, B3, B4, ArgTs...)> cb, C0 c0, C1 c1, C2 c2, C3 c3, C4 c4);
