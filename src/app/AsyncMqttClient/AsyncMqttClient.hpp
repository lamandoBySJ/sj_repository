...
namespace mqtt{
  ...
  struct MQTTSubscription {
    std::string topic;
    uint8_t qos;
    mbed::Callback<void(uint16_t packetId, uint8_t qos)> callback;
    bool subscribed;
...
*/
  AsyncMqttClient& onConnect(mbed::Callback<void(bool)> callback);
  ...
  */
  std::vector<mbed::Callback<void(bool)>> _onConnectUserCallbacks;
