...
void ESPWebService::run_web_service()
{
    ...
    platform_debug::TracePrinter::printTrace(Platform::getWebProperties().ap_ssid);
    platform_debug::TracePrinter::printTrace(Platform::getWebProperties().ap_pass);
    WiFi.mode(WIFI_OFF);
