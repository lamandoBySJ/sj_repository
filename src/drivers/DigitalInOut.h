 ...
 */
class DigitalInOut :public gpio_t
{
...
public:
     ...
     */
    DigitalInOut(PinName pin) : gpio_t()
    {
        // No lock needed in the constructor
        gpio_init_out(this, pin);
    }
     ...
     */
    DigitalInOut(PinName pin, PinDirection direction, PinMode mode, int value) : gpio_t()
    {
        // No lock needed in the constructor
        gpio_init_inout(this, pin, direction, mode, value);
    }
